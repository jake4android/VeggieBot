////Veggiebot V1.0, Created by DJ Mash13jake.////

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////BEGIN SET UP
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var Bot = require('ttapi');
var AUTH = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'; //set the auth of your bot here.
var USERID = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'; //set the userid of your bot here.
var ROOMID = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'; //set the roomid of the room you want the bot to go to here.

...
var roomJoinMessage = 'Welcome to my room, Enjoy your stay!'; //the message users will see when they join the room, leave it empty for the default message (only works when greet is turned on)
    ...
    if ((length / 60) >= songLengthLimit)
    {
        if (lastdj == USERID || masterIndex == -1) //if dj is the bot or not a master
        {
            if (LIMIT === true)
            {
                ...
                {
                    bot.speak('current dj, your song is over ' + songLengthLimit + ' mins long, you have 60 seconds to skip before being removed.');
                }
...
bot.on('speak', function (data)
{
    ...
    else if (text.match(/^\/veggies/))
    {
        bot.speak('EAT YOUR VEGGIES.');
    }
    ...
    {
        bot.speak('the commands are  bot dance, ' +
            ' /mom, im sexy, /cheers, /fanratio @, /whosrefreshing, /refresh, /whatsplaylimit, /warnme, /theme, /up?, /djafk, /mytime, /playlist, /afk, /whosafk, /coinflip, /moon, /hello, /escortme, /stopescortme, /fanme, /unfanme, /roominfo, /beer, /dice, /props, /m, /getTags, ' +
            '/skip, /dive, /dance, /smoke, /surf, /uptime, /djplays, /queuecommands');
    }
    else if (text.match(/^\/queuecommands/))
    {
        bot.speak('the commands are /position, /queuewithnumbers, /removefromqueue @, /removeme, /move, q+, q-, q /queueOn, /queueOff, /bumptop @');
    }
    ...
    else if (text.match('bot dance'))
    {
        bot.vote('up');
    }
    else if (text.match('bot dance'))
    {
        bot.speak('do the veggie boogie');
    }
    ...
    else if (text.match(/^\/inform$/) && condition === true)
    {
        if (checkWhoIsDj !== null)
        {
            if (informTimer === null)
            {
                ...
                bot.speak('@' + theUsersList[checkDjsName] + ' your song is not the appropriate for this room, please skip or you will be removed in 20 seconds');
                informTimer = setTimeout(function ()
                {
                    bot.pm('Sorry, you took too long to skip your song', lastdj);
                    bot.remDj(lastdj);
                    informTimer = null;
                }, 20 * 1000);
            }
    ...
    else if (text.match(/^\/mom$/))
    {
        ...
        {
        case 0:
            bot.speak('@' + name + ' ur mom is AWESOME');
            break;
        case 1:
            bot.speak('@' + name + ' I did your mom a fovor, by making you, a SANDWHICH. HAH');
            break;
        case 2:
            bot.speak('@' + name + ' your mom is so cool');
            break;
        case 3:
    ...
    else if (text.match('im sexy'))
    {
        bot.speak('@' + name + ' is deff a stud muffin');
    }
